...
public class GraphPanel extends JPanel {
    ...
    public void setArithmeticPath(List<Vector> pcaPath, List<String> labels, String resultWord) {
        ...
        // center the view roughly on the start of the path
        ...
        if (arithmeticPathVectors != null && !arithmeticPathVectors.isEmpty()) {
            ...
            if (arithmeticResultWord != null && prevPt != null) {
                ...
                if (resultWe != null) {
                    ...
                    Stroke dashed = new BasicStroke(1.5f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0,
                            new float[] { 6 }, 0);
    ...
    private void drawArrow(Graphics2D g2, int x1, int y1, int x2, int y2) {
        ...
        if (Point.distance(x1, y1, x2, y2) < 5)
            return;
